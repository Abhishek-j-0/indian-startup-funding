...
| 2 | SQL (MySQL + Python) | 🔄 In Progress | [03_sql/](03_sql/) |
| 3 | Python (Pandas, Matplotlib) | ⏭️ Planned | [04_python/](04_python/) |
...
**Status:** Currently in progress. Will be uploaded when complete.

**Planned Content:**
- 3-stage data cleaning pipeline (Python + SQL)
- 20+ business queries answering specific questions
- Window functions (LAG, RANK, DENSE_RANK)
- Common Table Expressions (CTEs)
- Multi-table JOINs
- Comparative analysis with Excel findings
...
- **May 2026:** Started SQL phase (currently in progress)
- **Coming:** Python phase, Power BI phase
